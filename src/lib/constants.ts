...
export const API_CONFIG = {
  BASE_URL: process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:5268/api",
  IMAGE_BASE_URL: process.env.NEXT_PUBLIC_API_BASE_URL?.replace('/api', '') || "http://localhost:5268",
} as const;
